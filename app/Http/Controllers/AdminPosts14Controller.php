<?php namespace App\Http\Controllers;
	...
	class AdminPosts14Controller extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		//	$this->col[] = ["label"=>"Tags","name"=>"tags"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Category Id','name'=>'category_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'categories,name'];
